...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
	  ...
	  http.authorizeRequests()
	   ...
	   .antMatchers("/seguimiento/**").hasAnyAuthority("ADMIN","COORSIS","GERSIS","JEFESIS")
	   .antMatchers("/acuerdos/**").hasAnyAuthority("ADMIN","COORSIS","GERSIS","JEFESIS")
	   .antMatchers("/proveedor/desarrollo/**").hasAuthority("PROVDES")
	   .antMatchers("/proveedor/gestion/**").hasAuthority("PROVGEST")
